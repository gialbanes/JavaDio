...
public class EstoqueProdutos {
    ...
    public Produto obterProdutoMaisCaro(){
        ...
        double maiorPreco = Double.MIN_VALUE; // quando o laco comecar, independente do valor dele, já vai ser o maior preço, e depois compara os valores
        if(!estoqueProdutosMap.isEmpty()){
            for(Produto p : estoqueProdutosMap.values()){
    ...
    public Produto obterProdutoMaisBarato(){
        ...
        double menorPreco = Double.MAX_VALUE; // quando o laco comecar, independente do valor dele, já vai ser o menor preço, e depois compara os valores
        if(!estoqueProdutosMap.isEmpty()){
            for(Produto p : estoqueProdutosMap.values()){
